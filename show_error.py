...
f_test = open("./result/error/test/2022-11-15 18-23-53.json", 'r')
test_json = json.load(f_test)
f_train = open("./result/error/train/2022-11-15 18-23-53.json", 'r')
...
# fig.legend()
fig.savefig("./result/error/err-2022-11-15 18-23-53.png")
